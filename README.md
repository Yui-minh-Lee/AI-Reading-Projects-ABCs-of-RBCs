...
- 建立了“生成初稿—人工阅读批注—难点澄清—写回修订”的迭代流程，并沉淀了对应 Prompt。
...
- **质量控制：**不把 AI 初稿视为最终版本；通过实际阅读、批注、追问和原文核对完成质量闭环。
- **独立思考：**note 中保留我的疑问、理解和修正，使 AI 产出逐步转化为个人知识，而不是停留在复制生成内容。
- **知识沉淀：**把一次性对话转化为结构化文件、个人注释、可复用 Prompt 和可持续维护的学习仓库。
